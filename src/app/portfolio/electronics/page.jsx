...
export default async function ElectronicsPortfolioPage() {
  const projects = await getAllProjects();
  
  const electronicsProjects = projects.filter((p) => p.category === "electronics");
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {electronicsProjects.map((project) => (
                ...
                >
                  ...
                  <Link
                    href={`/portfolio/electronics/${project.slug}`}
